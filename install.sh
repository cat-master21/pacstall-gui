...
wget -q --show-progress --progress=bar:force -O "/usr/bin/pacstall-gui" "https://github.com/cat-master21/pacstall-gui/raw/master/pacstall-gui"
chmod +x "/usr/bin/pacstall-gui"
